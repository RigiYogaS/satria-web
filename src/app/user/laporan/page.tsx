// TODO: Buat komponen LaporanMingguan di folder components
// import LaporanMingguan from "@/components/laporanMingguan";
    ...
    <SidebarProvider className="font-montserrat">
      ...
      <main className="flex-1 p-6">
        ...
        <div className="mt-4">
          ...
          <p>Upload dan kelola laporan mingguan Anda</p>

          <div className="mt-6 bg-white p-6 rounded-lg shadow">
            <h2 className="text-xl font-semibold mb-4">Upload Laporan</h2>
            <p className="text-gray-600">
              Silakan buat komponen laporanMingguan.tsx di folder components...
            </p>
          </div>
        </div>
      </main>
